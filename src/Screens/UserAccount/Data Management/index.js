...
export const MedicalReport = () => {
  ...
  useEffect(() => {
    ...
    fetch(`${base_url}/api/admin/userdetails_listing`,
      {
        method: 'GET',
        headers: {
              ...
              <div className="dashCard">
                <div className="row mb-3 justify-content-between">
                  <div className="col-md-4 mb-2">
                    <h2 className="mainTitle">Medical Reports</h2>
                  </div>
                      ...
                      <tbody>
                        {currentItems.map((item, index) => (
                          <tr key={index}>
                            ...
                            {/* <td>{item.username}</td> */}
                            <td>{item?.user_details?.bloodgroupdetails?.name}</td>
                            <td>{item?.user_details?.age}</td>
                            <td>{item?.user_details?.gender?.name}</td>
