...
export const UserReport = () => {
  ...
  const filterData = data.filter(item =>
    item.report_name.toLowerCase().includes(inputValue.toLowerCase())
  );
  ...
  const UserReports = () => {
    ...
    fetch(`${base_url}/api/admin/userreport_listing`,
      {
        method: 'GET',
        headers: {
  ...
  useEffect(() => {
    document.title = 'Medical Customer Portal | User Reports';
    UserReports()
              ...
              <div className="dashCard">
                <div className="row mb-3 justify-content-between">
                  <div className="col-md-6 mb-2">
                    <h2 className="mainTitle">Users Report</h2>
                  </div>
                  <div className="col-md-6 mb-2">
                    <div className="addUser">
                      <CustomButton text="Add Report" variant='primaryButton' onClick={hanldeRoute} />
                      ...
                      <tbody>
                        {currentItems.map((item, index) => (
                          <tr key={index}>
                            ...
                            <td><a href={base_url +'/'+ item?.file} className="text-info" target="_blank">View Report</a></td>
                            <td>
