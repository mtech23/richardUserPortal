...
export const Subscription = () => {
  ...
  useEffect(() => {
    ...
    fetch(`${base_url}/api/admin/subscription_listing`,
      {
        method: 'GET',
        headers: {
              ...
              <div className="dashCard">
                <div className="row mb-3 justify-content-between">
                  <div className="col-md-4 mb-2">
                    <h2 className="mainTitle">Subscription</h2>
                  </div>
                  <div className="col-md-4 mb-2 d-flex justify-content-end">
                    <CustomButton text="Add Subscription" variant='primaryButton' onClick={hanldeRoute} />
                  </div>
                  <div className="col-md-8 mb-2">
                    <div className="addUser align-items-end">
                      ...
                      />
                      <CustomInput type="text" placeholder="Search by Subscription..." value={inputValue} inputClass="mainInput" onChange={handleChange} />
                    </div>
                  </div>
                </div>
                <div className="row mb-3">
                            ...
                            <td>
                              <Dropdown className="tableDropdown">
                                ...
                                <Dropdown.Menu align="end" className="tableDropdownMenu">
                                  <Link to={`/subscription/subscription-detail/${item?.id}`} className="tableAction"><FontAwesomeIcon icon={faEye} className="tableActionIcon" />View</Link>
                                  <Link to={`/subscription/edit-subscription/${item.id}`} className="tableAction"><FontAwesomeIcon icon={faEdit} className="tableActionIcon" />Edit</Link>
                                </Dropdown.Menu>
                              </Dropdown>
                            </td>
                          </tr>
